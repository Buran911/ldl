...
public class TypeMismatchTest {
	...
	ParseError templateErr = new ParseError(ErrorType.UncompatibleTypes, 1, null);
	...
	ParseError templateErr = new ParseError(ErrorType.UncompatibleTypes, 6, null);
	...
	ParseError templateErr = new ParseError(ErrorType.UncompatibleTypes, null, null);
