...
public class SecondDefinitionTest {
    ...
    @Test
    public void test1() {
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/desc.ldl").split(" "));
    ...
    public void test2() {
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/desc1.ldl").split(" "));
	ParseError templateErr2 = new ParseError(ErrorClass.semantic,
		ErrorType.IdentifierRedefenition, 2, null);
    ...
    public void test3() {
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/desc2.ldl").split(" "));
	ParseError templateErr2 = new ParseError(ErrorClass.semantic,
		ErrorType.IdentifierRedefenition, 2, null);
	app.readFiles();
	app.checkErrors();
    ...
    public void test4() {
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/desc3.ldl").split(" "));
	ParseError templateErr2 = new ParseError(ErrorClass.semantic,
		ErrorType.IdentifierRedefenition, 2, null);
	...
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/pred.ldl").split(" "));
	...
	AppTest app = new AppTest(("-p testdata/semantictests/2nddef/property.xml "
		+ "-s testdata/semantictests/2nddef/pred2.ldl").split(" "));
